...
\end{equation}
and $\hat \psi^{
\dagger}_{H_{\alpha}}(x,t)$ is a creation operator in the Heisenberg picture.
\begin{equation}
\hat \psi^{
\dagger}_{H_{\alpha}}(x,t) \equiv e^{\mathrm{i}\hat{H}t/\hbar}\hat \psi^{
\dagger}_{\alpha}(x)e^{-\mathrm{i}\hat{H}t/\hbar} \nonumber
\end{equation}
...
\begin{equation}
\mathrm{T}[\hat \psi^{
\dagger}_{H_{\alpha}}(x,t)\hat \psi_{H_{\beta}}(x',t')]=\begin{cases}
\hat \psi^{\dagger}_{H,\alpha}(x,t)\hat \psi_{H,\beta}(x',t') &t>t' \cr  \pm \hat \psi_{H,\beta}(x',t')\hat \psi^{\dagger}_{H,\alpha}(x,t) &t<t'
\end{cases}\nonumber
\end{equation}
